...
public class evc_plus {
    ...
    private static final int USER_PIN = 1728;
    private static final int ACCOUNT_NUMBER = 2727800;
    private static final int BUSINESS_ID = 7800;
    private static final int BANK_PIN = 2839;
    private static final int OLD_BANK_PIN = 2025;
    private static final long TRANSACTION_ID = 123456789l;
    private static final int OTP_CODE = 5;
    private static final int WITHDRAWAL_CODE = 8268;

    // Initial balances
    private static int mobileBalance = 100;
    private static int bankAccountBalance = 8000;
    ...
    public static void showWelcomeScreen() {
        System.out.println("-kuso dhawaaw evc plus\n");
        System.out.print("fadlan soo gali furaha evc_pluska: ");
